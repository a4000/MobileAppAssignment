...
function scene:create ( event )
	...
	local path =  system.pathForFile( "AboutUs.txt", system.ResourcesDirectory )
	...
	local BackButton = widget.newButton(
	{
		...
		font = "Stencil",
		fontSize = 18,
		labelColor = { default={ 0.4,0.1,0.9 }, over={  0,0,0 } },
		...
		height = 40,
		cornerRadius = 6,
		fillColor = { default={0.8,0.9,0.8}, over={  0.8,0.9,0.8 } },
		strokeColor = { default={0,0,0}, over={0.4,0.1,0.9} },
		strokeWidth = 2
    	})
