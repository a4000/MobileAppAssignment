...
-- Function to take the username input from the username box. 
...
-- Function to take the phone input from the phone box. 
...
local function SubmitScene( event )
	if ( "ended" == event.phase ) then
		...
		local insertQuery = [[INSERT INTO employee VALUES (NULL, "]]..inputName..[[", "]]..inputUsername..[[", "]]..inputPassword..[[", "]]..inputPhone..[[", "]]..inputType..[["); ]]
		db:exec(insertQuery)		
...
------------------------------------------------------------------
	...
	-- Name Label.
	nameLabel = display.newText( "Name:", 90, 165, "STENCIL", 25)
	nameLabel:setFillColor(0, 255, 0)
	nameLabel.anchorX = 0
	nameLabel.y = 10
	...
	-- Phone Label.
	phoneLabel = display.newText( "Phone:", 90, 165, "STENCIL", 25)
	phoneLabel:setFillColor(0, 255, 0)
	phoneLabel.anchorX = 0
	phoneLabel.y = 220
	sceneGroup:insert( phoneLabel )
	
	-- Type Label.
	typeLabel = display.newText( "Type:", 90, 165, "STENCIL", 25)
	typeLabel:setFillColor(0, 255, 0)
	typeLabel.anchorX = 0
	typeLabel.y = 290
...
function scene:show( event )
	local sceneGroup = self.view
		...
		-- Name Field.
		nameField = native.newTextField( 50, 45, 220, 30 )
		...
		-- Username Field.
		usernameField = native.newTextField( 50, 115, 220, 30 )
		...
		-- Password Field.
 		passwordField = native.newTextField( 50, 185, 220, 30 )
		...
		-- Phone Field.
		phoneField = native.newTextField( 50, 255, 220, 30 )
		...
		-- Type Field.
 		typeField = native.newTextField( 50, 325, 220, 30 )
