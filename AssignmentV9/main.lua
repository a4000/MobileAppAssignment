...
-- ECU Joondalup needs to be in the database to be able to test if the app works properly.
-- Start by looping through the site table and check if there is a ECU Joondalup site.
local ecuInDB = 0
...
-- If ECU Joondalup is not found in the database, insert a ECU Joondalup into the database.
if (ecuInDB == 0) then
