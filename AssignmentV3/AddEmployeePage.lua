...
function scene:show( event )
	local sceneGroup = self.view
		...
		-- Name Field.
		nameField = native.newTextField( 20, 35, 220, 32 )
		...
		-- Username Field.
		usernameField = native.newTextField( 20, 105, 220, 32 )
		...
		-- Password Field.
 		passwordField = native.newTextField( 20, 175, 220, 32 )
		...
		-- Phone Field.
		phoneField = native.newTextField( 20, 245, 220, 32 )
		...
		-- Type Field.
 		typeField = native.newTextField( 20, 315, 260, 32 )
